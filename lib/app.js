 ...
 * 
 * It returns a Mixin which should be added to your App (top-level Component).
 */
				...
				<div className="view">
					...
					<div className="panel">
						<div className="panel-inner">
							View <strong>"{this.state.currentView}"</strong> is not available.
						</div>
					</div>
				</div>
			);
