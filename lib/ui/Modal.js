...
module.exports = React.createClass({
	...
	render: function() {
		...
		var backdropDiv = <div className="Modal-backdrop"/>
		var backdrop = this.props.onTapOut ? <Tappable onTap={this.props.onTapOut}>{backdropDiv}</Tappable> : backdropDiv
